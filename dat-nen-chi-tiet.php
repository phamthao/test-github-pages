    ...
    <div class="p-detail-6">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="b-slide-1">
                        <div class="b_thumb ht-ratio--100"><span class="ht-ratio__img"><img src="images/dat-nen-1.png" alt=""></span></div> <!--595x595-->
                        <div class="b_nav">
                            <ul>
                            <?php for($i = 1; $i <= 6; $i++){ ?>
                                <li>
                                    <a href="javascript:;" data-image="images/dat-nen-<?php echo $i ?>.png">
                                        <img src="images/dat-nen-<?php echo $i ?>.png" alt="" /> <!--149x149-->
                                    </a>
                                </li>
                            <?php } ?>
                            </ul>
                ...
                <div class="col-lg-6">
                    <div class="p_box">
                        <div class="status lease">Cho thuê</div> <!-- Còn trống: empty , đã bán: sold, cho thuê: lease -->
                        <h1 class="title">Đất nền 4 mặt tiền khu vực Long Thành</h1>
                        ...
                        <ul class="info">
                            <li class="fa-linode"><span>Diện tích:</span> 1.000 ha</li>

                            <li class="fa-compass"><span>Hướng:</span> Tây Bắc</li>
                    ...
                    <div class="p_form">
                        <h2 class="title"><span>Đặt lịch hẹn</span></h2>
                        ...
                        <form id="form_s-form-4" action="" method="POST" accept-charset="utf-8" enctype="multipart/form-data" novalidate="novalidate">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="Đất nền 4 mặt tiền khu vực Long Thành">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group c-form-border c-form-border--icon">
                                        ...
                                        <textarea name="content" class="c_input" rows="5" placeholder="Mô tả yêu cầu"></textarea>
                                    </div>
            ...
            <div class="p_detail ht-mrt30">
                <div class="ht-format-detail">
                    ...
                    <p style="text-align: center;">
                        <img src="images/dat-nen-1.png" /><br />
