            ...
            <div class="ht-page__main">
                <div class="s-list-1">
                    <div class="c-headline-9">
                        ...
                        <h2 class="c_name">Đất nền quận 7</h2>
                    </div>
                    <!-- <div class="h3 text-uppercase text--secondary text-center">Không tìm thấy dự án...</div> Thêm vào khi tìm kiếm rỗng-->
                        ...
                        <div class="col-12 col-xs-6 col-md-4">
                            <a href="dat-nen-chi-tiet.php" class="b-card-44">
                                <div class="b_thumb ht-ratio--100">
                                    <img src="images/dat-nen-<?php echo $i ?>.png" alt="" class="ht-ratio__img">
                                    <div class="overlay">
